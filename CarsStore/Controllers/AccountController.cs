    ...
    public class AccountController : Controller
    {
       ...
       ISecureDataFormat<AuthenticationTicket> accessTokenFormat, ApplicationRoleManager roleManager)
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (role.ToLower() == "disabled") {
                ModelState.AddModelError("", "Disabled users are not allowed to log in");
                return View(model);
            }
        ...
        [HttpPut]
        [Authorize(Roles = "Admin,Sales")]
        public ActionResult ChangePassword(UI.Models.ChangePasswordViewModel model)
        {
            ...
            {
                ModelState.AddModelError("model.Password", "Please enter password");
            }

            if(string.IsNullOrEmpty(model.ConfirmedPassword)) {
                ModelState.AddModelError("model.ConfirmedPassword", "Please enter confirmed password");
            }
        ...
        //        return View("Error");
        //    }
        //    return View(new UI.Models.AccountViewModels.VerifyCodeViewModel { Provider = provider, ReturnUrl = returnUrl, RememberMe = rememberMe });
        //}
